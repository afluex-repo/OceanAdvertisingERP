...
namespace FutureFundGlobalERP.Models
{
    public class DBHelper
    {
        ...
        static DBHelper()
        {
            try
            {
                connectionString = "Data Source=103.48.51.111,1232;Initial Catalog=OceanERPDB;User Id=oceanerpuser;Password=ocean@341&1;Integrated Security=false;";
            }
            catch (Exception)
            {
                throw;
